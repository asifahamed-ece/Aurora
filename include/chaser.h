...
public:
    ...
    /**
     * Set the breathing / chaser period in milliseconds.
     */
    void setPeriod(uint16_t periodMs) { if (periodMs > 0) _periodMs = periodMs; }
    uint16_t period() const { return _periodMs; }
